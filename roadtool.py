...
def search_streets(map):
	...
	if stype == '1':
		...
		map.search_street_by_name(name, True)
	elif stype == '2':
		valid, lat, lon = parse_gps()
		if valid:
			addr, e = map.compute_addr_repr(lat, lon, None)
...
####
def show_help():
	print("(1) Entry of new street")
	print("(2) Search streets")
	print("(3) Entry of new route")
	print("(4) Search routes")
	print("(5) Search nodes")
